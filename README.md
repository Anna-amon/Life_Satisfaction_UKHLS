...
## Mean absolute SHAP values - granular analysis

The mean absolute SHAP values may be visualised using bee swarm plots. as can be seen for the extended set of variables in figures 4, 5 and 6, and for the limited set of variables in figures 7, 8 and 9. The extended SHAP visualisations are for the 2018 dataset and the limited SHAP plots are for the 2021 results, given the
inclusion of the social media variable. The results across calendar years were very similar, so here only one year of plots have been included. A dot indicates the magnitude and direction of each feature to the model output, and the colour of a dot shows the absolute value of each variable. For example, pink dots represent higher feature values, and blue ones represent lower feature values. If a variable is binary, the high feature value of the variable means that respondents answered ’No’ to the question. For example, for smoker and single, respondents who smoke and are single are likely to have lower levels of life satisfaction. If the data point colors are very mixed, it indicates a more complicated relationship than expected.

The direction of the SHAP values for both the extended and limited datasets are mostly as expected, and in line with previous research on this topic. For the extended dataset, those who have poor mental health, are less satisfied with their health, feel lonely, are lacking in companionship, and find it difficult to overcome
difficulties, are more likely to negatively impact the model predictions, meaning they are more likely to report lower life satisfaction. Similarly, those who have more health conditions, do not own property, rent from a local authority, smoke, and have lower income, are also more likely to negatively impact the model
predictions. The variables showing more complex relationships are frequency of posting on social media, and household and individual income. For the 60+ age group, higher income is actually predicting lower SHAP values and vice versa. If we consider the descriptive statistics in table 20, the mean life satisfaction by income
group is not as varied for the older age groups as it is for the two younger age groups, which explains the differences in the model predictions. The same can be seen for the 35-59 age group for individual income, which may be again due to the descriptive statistics showing variability. If we consider the objective only models, the relationship with the income variables change again, with those on a lower income predicting lower life satisfaction scores for both the 36-59 and 60+ age groups.

In terms of social media, shown in the limited dataset SHAP values, the clearest relationship can be seen for those aged 60+, where posting on social media frequently leads to lower life satisfaction. However, for the two younger age groups, the results are mixed. These results indicate the complexity of the relationship between income, social media and life satisfaction, and with income, this appears to change once subjective indicators are taken into account. To understand these relationships further, more in-depth surveys on these topics are likely needed.

## Mean absolute SHAP values - evidence of a ceiling effect

For the final section of the analysis, we may consider the mean absolute SHAP Values for the final test set, for each point on the life satisfaction scale from 1-7. If we consider the average SHAP values for each point on the life satisfaction scale, we can see the contributions to the predictions for most features are higher for the lower values on the scale (Figure 5). This may indicate that those with high life satisfaction may have a more equal distribution of scores across the different predictors, making it difficult for the model to differentiate between fluctuations in the predictor variables and how these impact life satisfaction. In comparison, those with low life satisfaction may have more variability in their scores across the different predictor variables, and these differences may have more impact on their life satisfaction. Overall, this relates to a possible ceiling effect, where once individuals reach a high enough level of life satisfaction, changes in their circumstances
do not impact their life satisfaction as much, whereas for those with lower life satisfaction, a change in their circumstances may vary their life satisfaction more significantly. Additionally, it may point toward the interrelated nature of all of these predictors, and how difficulty in one area of an individuals life may then affect other areas too.

## Discussion

The first thing to note is that there has been a significant decrease in life satisfaction for all age groups, from 2018 to 2021. Although this study has not shown causation, we can infer this is as a result of COVID-19. The largest significant decline is for those aged 60+, followed by those aged 16-35 and those aged 36-59
show the least significance. This is in contrast to the previous literature showing young people being the most impacted by the COVID-19 pandemic. However, there are differences between the analysis, in terms of the time frame and the age groups. The previous research considered life satisfaction during COVID-19, rather than before and after, and for those aged 18-29, as opposed to those aged 16-35. If we were to change the age grouping in this analysis we may find different results. The same change may also be carried out for those aged 60+, where the results may differ if we were to further divide the age group to those aged 60-80, and those aged 80+, as life satisfaction for the latter age group may be due to those aged 80+ experiencing a worse decline due to their experiences of the pandemic. It may pull the mean lower than if we only consider a smaller age range, such as those aged 60-80. Additionally, if we consider the decline in life satisfaction over a much larger period of time, say from 2011, the results may also change. Since 2011, the UKHLS dashboard indicates decreases in well-being over ten years, which appears, from the descriptive statistics, more dramatic for the youngest age group.

Another interesting insight from these results are the results of the Mann-Whitney U test and the descriptive statistics shown in Figures 3 and 4. These figures indicate a change in the U-shaped curve. However, the reasons for this are two fold; firstly, those aged 16-35 have seen a more significant decline in their life
satisfaction than those ages 36-59, which is part of the contribution to the change in the trend. However, the other contribution is due to those in the middle age group not having experienced as substantial a decline in life satisfaction, as those ages 16-35, and aged 60+. It is both of these factors combined that results in the trend change, as it has created an almost levelling out affect. If we consider the similarities and differences between predictors, overall, the 2018 and 2021 both extended and limited datasets evidence very similar predictors for each age group, and across age groups, in predicting life satisfaction. The features that stand out as having the most varied ranking across age groups are relationship status and property ownership, which both decrease in model importance as people get older. Furthermore, regarding the direction of the relationships between the independent and dependent variables, we can see differences in income across age groups, with those receiving lower income for the two youngestage groups predicting lower life satisfaction, more so than those receiving lower income within the older age group. Overall, this demonstrates younger people are more affected by differences in income, relationship status, and their housing situation than older people. Reasons for this likely relate to the social expectations placed on younger people, which likely subside as you reach older ages.

Regarding subjective and objective variables, the XGBoost model performs best with the extended dataset and similarly well with the subjective-only dataset, but not as well with the objective-only dataset. This suggests that subjective factors are likely more predictive of the outcome, and that the model is relying more
on these features for the predictions. However, this is not to say the objective variables have no association with life satisfaction. The objective model R² values are relatively weak, although an acceptable level for social science research, and still indicate enough predictive power to provide accurate predictions within a threshold of 1, for 60-65 percent of the data. This confirms that when predicting life satisfaction, objective variables should not be ignored. However, this also points to the mediating effect of the subjective variables on life satisfaction. Understanding the relationship between the subjective and objective variables is beyond the scope of this study, however, what this analysis has confirmed is that the two limited sets of variables can correctly predict life satisfaction in at least 65 percent of individuals, therefore it will be beneficial to consider both subjective and objective variables when predicting life satisfaction in future research. 

Furthermore, this research also confirms the importance of social policy well-being improvements to not only consider mental health and resilience interventions but to consider the wider social and economic factors too. The analysis has highlighted that life satisfaction has a potential ceiling effect. This shows that once individuals reach a certain level of satisfaction with their life, improvements may not alter satisfaction levels significantly. On the other hand, a negative life experience, or feeling particularly dissatisfied in one or more areas of life, may have a much greater, compounding and cumulative affect on the individuals overall satisfaction. If we consider this in relation to COVID-19 and evidence of these shocks having exacerbated preexisting inequalities, the overall worsening in life satisfaction may be as a result of the pandemic impacting individuals with worse mental well-being, than those whose well-being was already higher pre-pandemic.

This is an important insight for this research for two reasons. Firstly, it confirms that those whose wellbeing was already low pre-pandemic, may be at higher risk of their mental health declining at a more substantial rate than those whose well-being was higher. This may relate to resilience, and the ability to bounce back from adversity when you are already lacking in resources and coping mechanisms. Second, these insights indicate that policies to improve well-being for individuals who are already reporting low levels of life satisfaction, may have more of an overall beneficial impact and significant affect on well-being for these people, and therefore be a more effective use of resources, as opposed to blanket attempts to raise life satisfaction for the whole population.
